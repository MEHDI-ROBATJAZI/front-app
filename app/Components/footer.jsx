  ...
  const skype_mouse_leave=()=>{
	...
	return(
      ...
      <svg id="wave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#adadad" fillOpacity="1" d="M0,96L30,85.3C60,75,120,53,180,69.3C240,85,300,139,360,176C420,213,480,235,540,218.7C600,203,660,149,720,133.3C780,117,840,139,900,170.7C960,203,1020,245,1080,234.7C1140,224,1200,160,1260,149.3C1320,139,1380,181,1410,202.7L1440,224L1440,320L1410,320C1380,320,1320,320,1260,320C1200,320,1140,320,1080,320C1020,320,960,320,900,320C840,320,780,320,720,320C660,320,600,320,540,320C480,320,420,320,360,320C300,320,240,320,180,320C120,320,60,320,30,320L0,320Z"></path>
      </svg>
		</Box>
	)		
}
